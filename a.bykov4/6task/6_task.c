...
// Функция построения таблицы строк
...
void print_line(int fd, int line_count, int line_number) {
...
void interactive_mode(int fd, int line_count) {
    char input[100];
    int line_number;
    ...
    while (1) {
        ...
        print_line(fd, line_count, line_number);
    }
}
...
int main(int argc, char *argv[]) {
    ...
    int line_count = build_line_table(fd);
    ...
    // Интерактивный режим
    interactive_mode(fd, line_count);
